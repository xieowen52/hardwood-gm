...
export const FRANCHISES: readonly Franchise[] = [
  { id: 'ATL', name: 'Atlanta', nameByDecade: { 1950: 'Milwaukee/St. Louis', 1960: 'St. Louis' }, colors: ['#C8102E', '#FDB927'] },
  { id: 'BOS', name: 'Boston', colors: ['#007A33', '#FFFFFF'] },
  { id: 'BRK', name: 'Brooklyn', nameByDecade: { 1970: 'New York/New Jersey', 1980: 'New Jersey', 1990: 'New Jersey', 2000: 'New Jersey' }, colors: ['#1A1A1A', '#FFFFFF'] },
  ...
  { id: 'GSW', name: 'Golden State', nameByDecade: { 1950: 'Philadelphia', 1960: 'San Francisco', 1970: 'San Francisco/Oakland' }, colors: ['#1D428A', '#FFC72C'] },
  { id: 'HOU', name: 'Houston', nameByDecade: { 1960: 'San Diego', 1970: 'San Diego/Houston' }, colors: ['#CE1141', '#C4CED4'] },
  { id: 'IND', name: 'Indiana', colors: ['#002D62', '#FDBB30'] },
  { id: 'LAC', name: 'Los Angeles', nameByDecade: { 1970: 'Buffalo', 1980: 'San Diego/Los Angeles' }, colors: ['#C8102E', '#1D428A'] },
  { id: 'LAL', name: 'Los Angeles', nameByDecade: { 1950: 'Minneapolis' }, colors: ['#552583', '#FDB927'] },
  { id: 'MEM', name: 'Memphis', nameByDecade: { 1990: 'Vancouver', 2000: 'Vancouver/Memphis' }, colors: ['#5D76A9', '#12173F'] },
  ...
  { id: 'NOP', name: 'New Orleans', nameByDecade: { 2000: 'New Orleans/Oklahoma City' }, colors: ['#0C2340', '#C8102E'] },
  { id: 'NYK', name: 'New York', colors: ['#006BB6', '#F58426'] },
  { id: 'OKC', name: 'Oklahoma City', nameByDecade: { 1960: 'Seattle', 1970: 'Seattle', 1980: 'Seattle', 1990: 'Seattle', 2000: 'Seattle/Oklahoma City' }, colors: ['#007AC1', '#EF3B24'] },
  { id: 'ORL', name: 'Orlando', colors: ['#0077C0', '#C4CED4'] },
  { id: 'PHI', name: 'Philadelphia', nameByDecade: { 1950: 'Syracuse', 1960: 'Syracuse/Philadelphia' }, colors: ['#006BB6', '#ED174C'] },
  { id: 'PHO', name: 'Phoenix', colors: ['#1D1160', '#E56020'] },
  { id: 'POR', name: 'Portland', colors: ['#E03A3E', '#1A1A1A'] },
  { id: 'SAC', name: 'Sacramento', nameByDecade: { 1950: 'Rochester', 1960: 'Cincinnati', 1970: 'Kansas City', 1980: 'Kansas City/Sacramento' }, colors: ['#5A2D81', '#63727A'] },
  { id: 'SAS', name: 'San Antonio', colors: ['#1A1A1A', '#C4CED4'] },
  { id: 'TOR', name: 'Toronto', colors: ['#CE1141', '#1A1A1A'] },
  { id: 'UTA', name: 'Utah', nameByDecade: { 1970: 'New Orleans/Utah' }, colors: ['#002B5C', '#F9A01B'] },
  { id: 'WAS', name: 'Washington', nameByDecade: { 1960: 'Chicago/Baltimore', 1970: 'Baltimore/Washington' }, colors: ['#002B5C', '#E31837'] },
];
